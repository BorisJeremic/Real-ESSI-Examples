...
thefile = "Hard_Contact_Normal_Load.h5.feioutput";
...
plt.plot(normal_strain*5,normal_stress/1000,Linewidth=4,label='$k_n = 800MPa$')
...
# axes.set_xlim([-7,7])
# axes.set_ylim([-1,1])
outfigname  = "HardContact_Response.pdf";
