...
do
    ...
    # =====================================================
    # Copy the default Comparator if no compare_HDF5_max.py is provided. 
    # =====================================================
    cd ${current_dir}/"${deepest_dir_array[$element]}"
    # =====================================================
    if [ -f $PWD/compare_HDF5_max.py ]
        then
            :
    else
       cp ${compare_function_dir}/compare_HDF5_max.py ${current_dir}/"${deepest_dir_array[$element]}"
    fi
    # =====================================================
