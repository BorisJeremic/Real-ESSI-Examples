...
do
    ...
    cp ./compare_function/compare_terminal_log.py ${current_dir}/"${deepest_dir_array[$element]}"
    ...
    make -f run_and_compare compare_terminal_log
done
