...
### Node tag 3287 is located at the center of free field model with coordinates (150, 0, -100)

node_ID = 3287; 

HDF5_master_Dir_prefix = '2D_free_field_model_SV_wave_layering.h5'; 

analytical_output_file = 'SW4_simulation_result.txt'; 
...
abs_error_limit = 0.10; 

rel_error_limit = 0.10; 
...
print headrun() , "----------- Comparison with SW4 v1.1 simulation result -----------------"; 

print headstep()   ,'{0}  {1}  {2}  {3}'.format('SW4 result  ', 'Real ESSI result  ','absolute error ', 'relative error[%]'); 
