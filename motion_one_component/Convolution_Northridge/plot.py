...
# acc_depth12 = np.loadtxt('Kobe_depth_12_acc.txt');   

acc_depth12 = np.loadtxt('Northridge_depth_12_acc.txt');   
...
plt.savefig('acc_convolution_Northridge.pdf', bbox_inches='tight'); 
