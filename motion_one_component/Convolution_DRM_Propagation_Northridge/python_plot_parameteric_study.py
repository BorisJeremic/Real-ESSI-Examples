...
# input_acc = np.loadtxt('Kobe_acc.txt'); 

# input_disp = np.loadtxt('Kobe_disp.txt'); 

input_acc = np.loadtxt('scaled_northridge_acc.dat'); 

input_disp = np.loadtxt('scaled_northridge_dis.dat'); 
