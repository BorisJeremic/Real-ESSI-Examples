...
pylab.savefig("Original_Effective_Stress_Principle_At_Interface.pdf",  bbox_inches='tight')
...
pylab.savefig("Original_Displacement_At_Interface.pdf",  bbox_inches='tight')
