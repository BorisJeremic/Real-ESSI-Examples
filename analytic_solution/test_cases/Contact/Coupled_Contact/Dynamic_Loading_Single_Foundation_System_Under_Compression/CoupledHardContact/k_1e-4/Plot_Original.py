...
# Loading Stage
# #########################################################################
thefile = "Original_SFS_Surface_Load.feioutput";
...
# Consolidation Stage
# #########################################################################
thefile = "Original_SFS_Consolidation.feioutput";
finput = h5py.File(thefile)
...
pylab.savefig("Original_Excess_Pore_Pressure.pdf",  bbox_inches='tight')
...
pylab.savefig("Original_Displacement_At_Interface",  bbox_inches='tight')
