...
do
    # ===================================================================
    # Replace the run_and_compare (Makefile):
    # Optional
    # ===================================================================
    cd ${current_dir}
    cp ./compare_function/leaf_folder_Makefile/run_and_compare ${current_dir}/"${deepest_dir_array[$element]}"
    ...
    cp ./compare_function/compare_txt.py ${current_dir}/"${deepest_dir_array[$element]}"
    cp ./compare_function/compare_HDF5_ALL.py ${current_dir}/"${deepest_dir_array[$element]}"

    cp ./compare_function/compare_HDF5_Displacement_Output.py ${current_dir}/"${deepest_dir_array[$element]}"
    cp ./compare_function/compare_HDF5_Gauss_Output.py ${current_dir}/"${deepest_dir_array[$element]}"
    cp ./compare_function/compare_HDF5_Element_Output.py ${current_dir}/"${deepest_dir_array[$element]}"
    # ===================================================================
    # Execution:
    # ===================================================================
    ...
    if [ -f "compare.sh" ]; then
    	make -f run_and_compare compare
    else
    	make -f run_and_compare compare_txt
    fi
done
