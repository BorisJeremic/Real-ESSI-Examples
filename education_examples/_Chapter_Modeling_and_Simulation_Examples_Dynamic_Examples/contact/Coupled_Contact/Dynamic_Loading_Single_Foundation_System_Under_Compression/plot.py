...
# pore_pressure
ax.plot(times,upU_p,'b',linewidth=4,label=r'Pore Pressure $p$'); 
ax.hold(True);
...
# kinetic energy 
ax.plot(times,sigma_zz,'k',linewidth=4,label=r'Total Stress $\sigma$'); 
ax.hold(True);
...
# kinetic energy 
ax.plot(times,sigma_zz_,'r',linewidth=4,label=r'''Effective Stress $\sigma^{\prime}$'''); 
ax.hold(True);
...
plt.legend()
pylab.savefig("Effective_Stress_Principle_At_Interface.pdf",  bbox_inches='tight')
...
pylab.savefig("Displacement_At_Interface.pdf",  bbox_inches='tight')
