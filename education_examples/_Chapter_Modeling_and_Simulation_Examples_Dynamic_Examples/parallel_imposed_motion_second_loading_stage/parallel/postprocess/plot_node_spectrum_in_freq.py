...
# # *************************************************************************************
with open(out_filename + '_freq_acc.txt', 'w') as f : 
	for i in range(len(freqs)) :
		f.write( str(freqs[i]) + " \t " + str(pseudo_acc_spec[i]) + "\n")

with open(out_filename + '_freq_disp.txt', 'w') as f : 
	for i in range(len(freqs)) :
		f.write( str(freqs[i]) + " \t " + str(dis_spec[i]) + "\n")


print(" Data is written to " + out_filename + '_freq_acc.txt')
print(" Data is written to " + out_filename + '_freq_disp.txt')
