...
# *************************************************************************************
with open(out_filename + '_period_acc.txt', 'w') as f : 
	for i in range(len(period)) :
		f.write( str(period[i]) + " \t " + str(pseudo_acc_spec[i]) + "\n")

with open(out_filename + '_period_disp.txt', 'w') as f : 
	for i in range(len(period)) :		
		f.write( str(period[i]) + " \t " + str(dis_spec[i]) + "\n")

print(" Data is written to " + out_filename + '_period_acc.txt')
print(" Data is written to " + out_filename + '_period_disp.txt')
