...
##############################################################################
# Go over each feioutput and plot each one.  
thefile = "Monotonic_Contact_Behaviour_Removing_Tangential_Load.h5.feioutput";
finput = h5py.File(thefile)
...
##############################################################################
# Go over each feioutput and plot each one.  
thefile = "Monotonic_Contact_Behaviour_Again_Adding_Tangential_Load.h5.feioutput";
finput = h5py.File(thefile)
